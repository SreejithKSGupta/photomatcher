<script lang="ts">
    ...
    function updateSliderImage() {
      ...
      if (slider) {
        slider.style.backgroundImage = isDarkTheme ? "url('./icons/dark.webp')" : "url('./icons/light.webp')";
      }
    }
  ...
  <header>
    ...
    <div class="theme-switch">
      <input type="checkbox" id="theme-toggle" on:change={toggleTheme} bind:checked={isDarkTheme}>
      <label class="slider" for="theme-toggle" aria-label="Toggle theme"></label>
    </div>
  </header>
  <slot />
  <Footer />
